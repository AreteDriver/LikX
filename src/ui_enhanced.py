...
def add_advanced_features_to_editor(editor_window):
    ...
    effects_btn.connect("clicked", lambda b: effects_menu.popup_at_widget(
...
class QuickActionsDialog:
    ...
    def __init__(self, parent=None):
        ...
        actions = [
            ...
            ("☁️ Screenshot + Upload", "Capture → Upload → Copy URL", self._screenshot_upload),
    ...
    def _quick_screenshot(self):
        ...
        show_notification("Quick Screenshot", "Press Ctrl+Shift+F for fullscreen\nor Ctrl+Shift+R for region")
    
    def _screenshot_ocr(self):
        """Screenshot then OCR workflow."""
        show_notification("Screenshot + OCR", "Capture a screenshot, then use the OCR button in the editor")
